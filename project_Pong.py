...
def new_game():
    ...
    global score1, score2, test  # these are ints
...
def draw(canvas):
    ...
    elif paddle1_pos <= HALF_PAD_HEIGHT and paddle1_vel >0:
        paddle1_pos = paddle1_pos + paddle1_vel
    ...
    # draw scores
    canvas.draw_text(str(score1)+' : '+str(score2),[250,90],60,'White')  
...
button = frame.add_button('Restart',button_handler,200)
